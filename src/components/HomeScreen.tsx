  ...
  return (
    <main className="flex-1 p-4 pb-8 max-w-md mx-auto w-full">
      <div className="space-y-4">
        ...
        >
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-white mb-1">3 Crew Calculator</h2>
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Convert times for entry into company portal format
          </p>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Latest wheels up time for flight and duty limitations
          </p>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <p className="text-sm text-neutral-500 dark:text-neutral-400">
            Calculate wheels up time in order not to break curfew
          </p>
        </button>
        <button
          type="button"
